# cnn_xiao.py -- does the realizability gap hold for a convolutional detector?
#
# WHY THIS RUN EXISTS
#
...
# unchanged from your own scripts via capability_cic.py / capability_unsw.py. The
...
#     python cnn_xiao.py cic
#     python cnn_xiao.py unsw        (or use cnn_xiao_unsw.py, dataset hard-set)
#
